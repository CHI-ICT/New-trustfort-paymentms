...
@Slf4j
public class FlutterJournalPostingService {
    ...
    public void postDoubleEntry(BigDecimal amount, String txRef, Wallet wallet, String description) {
        ...
        String debitAccountCode = getSystemAccountCode("FLUTTERWAVE_CONTROL");
        ...
        debitEntry.setDescription("Flutterwave incoming inflow");
