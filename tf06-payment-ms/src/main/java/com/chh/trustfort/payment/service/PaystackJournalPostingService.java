...
@Slf4j
public class PaystackJournalPostingService {
    ...
    public void postDoubleEntry(BigDecimal amount, String txRef, Wallet wallet, String description) {
        ...
        // 🔁 Hardcoded debit (Paystack clearing) — optionally get from Chart of Accounts
        String debitAccountCode = getSystemAccountCode("PAYSTACK_CONTROL");

        // 🧾 DEBIT: Paystack clearing account
        ...
        debitEntry.setDescription("Paystack incoming inflow");
