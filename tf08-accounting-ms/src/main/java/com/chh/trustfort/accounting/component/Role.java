...
public enum Role {
    ...
    GET_CASH_FLOW("G_CF"),
    GET_CONSOLIDATED_SUMMARY("G_C_S"),
    FINANCIAL_REPORT("F_R"),
    RECONCILE_BANK("R_B"),
    VIEW_AGING_SUMMARY("V_A_S"),
    AUTO_MATCH("A_M"),
    CASHFLOW_FORECAST("C_F"),
    CREATE_COA("C_C_O_A"),
    VIEW_COA("V_COA"), 
    VIEW_CONTRACT("V_C"), 
    REVERSE_DEBIT_NOTE("R_B_N"), 
    VIEW_DEBTOR_REPORT("V_D_R"), 
    DEPARTMENT_CODE("D_C"), 
    GET_ENTITY_CODES("G_EC"),
    UPDATE_ENTITY_CODE("U_EC"),
    DELETE_ENTITY_CODE("D_EC"),
    CREATE_ENTITY_CODE("C_EC"),
    GENERATE_EOP("G_EOP"),
    GET_EOP("G_EP"),
    VIEW_EQUITY_STATEMENT("V_E_S"),
    VIEW_RECEIPTS("V_R"),
    VIEW_PAYABLE_ALERTS("V_P_A"),
    VIEW_PAYABLE_REPORT("V_P_R"),
    RECONCILE_VENDOR_PAYMENTS("R_V_P"),
    CREATE_PURCHASE_ORDER("C_P_O"),
    VIEW_PURCHASE_ORDER("V_P_O"),
    PAYOUT_CLASSIFIER("P_C"),
    RECEIPT_ALERT("R_A"),
    REPORT_APPROVAL("R_A"), 
    REPORT_VIEWER("R_V"), 
    VIEW_TAX_REPORT("V_T_R"), 
    EXPORT_TAX_REPORT("E_T_R"), 
    TAX_ALERT("T_A"), 
    TRIAL_BALANCE_VIEW("T_B_V"),
    FINANCIAL_SUMMARY_VIEW("F_S_V"),
    REPORT_EXPORT("R_E"),
    VARIANCE_ANALYSIS_VIEW("V_A_V"),
    DASHBOARD_VIEW("D_V"),
    REPORT_MONITOR("R_M"),
    DOWNLOAD_REPORT("D_R"),

    ACCOUNT_CATEGORY("A_C");
