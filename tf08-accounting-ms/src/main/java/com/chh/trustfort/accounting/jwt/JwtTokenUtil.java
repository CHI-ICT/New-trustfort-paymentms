...
// ✅ Ensure both `C_WAL` and `W_BAL` exist
            ...
            if (!roles.contains(Role.CREATE_PO.getValue())) {
                roles.add(Role.CREATE_PO.getValue());
            }
            if (!roles.contains(Role.ALL_PO.getValue())) {
                roles.add(Role.ALL_PO.getValue());
            }
            if (!roles.contains(Role.CREATE_CONTRACT.getValue())) {
                roles.add(Role.CREATE_CONTRACT.getValue());
            }
            if (!roles.contains(Role.ALL_CONTRACT.getValue())) {
                roles.add(Role.ALL_CONTRACT.getValue());
            }
            if (!roles.contains(Role.TEST_ALERTS.getValue())) {
                roles.add(Role.TEST_ALERTS.getValue());
            }
            if (!roles.contains(Role.CREATE_INSTALLMENTS.getValue())) {
                roles.add(Role.CREATE_INSTALLMENTS.getValue());
            }
            if (!roles.contains(Role.POST_TO_GL.getValue())) {
                roles.add(Role.POST_TO_GL.getValue());
            }
            if (!roles.contains(Role.TRIGGER_RECONCILIATION.getValue())) {
                roles.add(Role.TRIGGER_RECONCILIATION.getValue());
            }
            if (!roles.contains(Role.CLASSIFY_INVOICE.getValue())) {
                roles.add(Role.CLASSIFY_INVOICE.getValue());
            }
            if (!roles.contains(Role.GET_PAYABLES_REPORT.getValue())) {
                roles.add(Role.GET_PAYABLES_REPORT.getValue());
            }
            if (!roles.contains(Role.SIMULATE_PAYMENT.getValue())) {
                roles.add(Role.SIMULATE_PAYMENT.getValue());
            }
            if (!roles.contains(Role.FORCAST.getValue())) {
                roles.add(Role.FORCAST.getValue());
            }
            if (!roles.contains(Role.GET_PROFIT_AND_LOSS.getValue())) {
                roles.add(Role.GET_PROFIT_AND_LOSS.getValue());
            }
            if (!roles.contains(Role.GET_BALANCE_SHEET.getValue())) {
                roles.add(Role.GET_BALANCE_SHEET.getValue());
            }
            if (!roles.contains(Role.GET_CASH_FLOW.getValue())) {
                roles.add(Role.GET_CASH_FLOW.getValue());
            }
            if (!roles.contains(Role.GET_CONSOLIDATED_SUMMARY.getValue())) {
                roles.add(Role.GET_CONSOLIDATED_SUMMARY.getValue());
            }
